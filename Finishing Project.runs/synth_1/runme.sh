...
HD_PWD='C:/Users/sinan/Finishing Project/Finishing Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_cpu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit_cpu.tcl
