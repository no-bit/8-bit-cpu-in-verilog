...
HD_PWD='C:/Users/sinan/Finishing Project/Finishing Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_cpu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bit_cpu.tcl -notrace
